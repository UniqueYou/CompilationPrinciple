...
if pyQtVersion == "PyQt4":
    ...
    from PyQt5.QtCore import Qt, QRect, QRegExp, QRegularExpression
...
class CHighlighter(QSyntaxHighlighter):
    ...
    def __init__(self, parent=None):
        ...
        for pattern in (r'main', r'if'):
            self.Rules.append((QRegExp(pattern), keyword_format))
        print(self.Rules)
...
class QCodeEditor(QPlainTextEdit):
    ...
    class NumberBar(QWidget):
        ...
        def __init__(self, editor):
            ...
            self.editor.setViewportMargins(19, 0, 0, 0)
    ...
    def __init__(self, DISPLAY_LINE_NUMBERS=True, HIGHLIGHT_CURRENT_LINE=True,
        ...
        self.setFont(QFont("Ubuntu Mono", 16))
